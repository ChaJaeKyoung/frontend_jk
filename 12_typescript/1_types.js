...
const favoriteMusic = { song: 'waybackhome', singer: 'SHAUN' };
...
let userInfo = [userName, userAge, married]; // 배열 안의 모든 요소가 string, number, undefined, boolean type만 들어올 수 있다.
