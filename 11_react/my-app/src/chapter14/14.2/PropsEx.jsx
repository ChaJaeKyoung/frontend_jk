...
function App(props) {
  ...
  return (
    <ThemeContext.Provider value="dark">
      <Toolbar/>
      {/*<Toolbar theme="dark"/>  // 원래는 theme에 dark를 넣어줬는데 이제 value값에 dark를 넣어주면 됨 */}
    </ThemeContext.Provider>
  );
}

function Toolbar(props) {
  // Toolbar 컴포넌트는 테마 props을 받아서 ThemeButton에 전달해야 함
  ...
  return (
    <div>
      <ThemedButton />
      {/* <ThemeButton theme={props.theme}/> //이제 이렇게 하는게 필요 없어짐 */}
    </div>
  );
}
...
function ThemedButton(props) {
  ...
  // return <Button theme={props.theme}; /> // 이제 이렇게 하는게 필요 없어짐
}